...
import jw.application.batch.chunk.processor.ApiItemProcessor1;
import jw.application.batch.chunk.processor.ApiItemProcessor2;
import jw.application.batch.chunk.processor.ApiItemProcessor3;
import jw.application.batch.chunk.processor.ProcessorClassifier;
import jw.application.batch.chunk.writer.ApiItemWriter1;
import jw.application.batch.chunk.writer.ApiItemWriter2;
import jw.application.batch.chunk.writer.ApiItemWriter3;
import jw.application.batch.chunk.writer.WriterClassifier;
import jw.application.batch.domain.ApiRequestVO;
import jw.application.batch.domain.ProductVO;
import jw.application.batch.partition.ProductPartitioner;
import jw.application.service.ApiService1;
import jw.application.service.ApiService2;
import jw.application.service.ApiService3;
